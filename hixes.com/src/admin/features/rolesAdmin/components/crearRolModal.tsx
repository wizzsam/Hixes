...
import { crearRol } from '../services/crearRol'
...
export default function CrearRolModal({ isOpen, onClose, onRolCreado }: CrearRolModalProps) {
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-600">
                                Registra un nuevo rol de sistema y sus detalles.
                            </p>
                        </div>
                    </div>
                    <button
